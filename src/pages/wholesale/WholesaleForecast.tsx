...
export default function WholesaleForecast() {
  ...
  return (
    <div className="max-w-3xl mx-auto py-8">
      <h1 className="text-3xl font-bold mb-4 text-blue-800">Inventory Forecasting (Wholesaler)</h1>
      ...
      <Card>
        ...
        <CardContent>
          <div className="flex flex-wrap gap-2 mb-2 items-center">
            ...
            <ExportButton data={filtered} filename="wholesale-forecasts.csv" disabled={filtered.length === 0} />
          </div>
          {filtered.length === 0 ? (
